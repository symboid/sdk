...
#ifndef __SYMBOID_SDK_CONTROLS_QUNIXTIMECONVERTER_H__
#define __SYMBOID_SDK_CONTROLS_QUNIXTIMECONVERTER_H__
...
#endif // __SYMBOID_SDK_CONTROLS_QUNIXTIMECONVERTER_H__
